...
def login_sciencedirect(email, password):
    ...
    driver.get("https://www-sciencedirect-com.crai.referencistas.com/search?qs=%22computational%20thinking%22&show=100")
    ...
    try:
        ...
        total_pages = int(match.group(1)) / 5  # Convertir a entero el segundo número en Page a of b
