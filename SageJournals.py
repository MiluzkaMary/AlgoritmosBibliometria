...
def login_sciencedirect(email, password):
    ...
    driver.get("https://journals-sagepub-com.crai.referencistas.com/action/doSearch?AllField=%22computational+thinking%22")
    ...
    try:
        ...
        #total_pages = int(pagination_last_link.text) / 4
        total_pages= 4
